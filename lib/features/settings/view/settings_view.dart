...
import 'package:cara_ou_coroa_gigachad_edition/features/settings/widgets/enable_score_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView(children: [ChangeThemeWidget(), Divider(height: 25), EnableAudioWidget(), EnableScoreWidget()]),
      ),
    );
  }
}
